---
date: '2025-12-28T10:26:09Z'
draft: false
title: 'Learn Computer Forensices Section 1: Acquiring Evidence'
categories: ["Book"]
...
- a response kit is unique to all digital forensic analysis which may include things such as:
	...
	- **Software security keys** - A decryption security key in the shape of a USB used to use the forensic software as some may become unavailable to use without it
		- A program called [VirtualHere](http://virtualhere.com/home) which allows you to use USB security keys remotely as long as there is a network connection at your destination
These should all be stored inside a Pelican-type case which should be crushproof and watertight along with a TSA-compliant locking device in case going abroad 
...
- **Autopsy:** fully functioning suite of forensic tools which can be found [here](https://www.sleuthkit.org/autopsy/) 
- **SIFT Workstation:** SIFT is a VM which contains multiple forensic tools pre-installed which can be found [here](https://digital-forensics.sans.org/community/downloads) 
- **Paladin Forensic Suite:** A live Linux Ubuntu OS with pre-installed open source forensic tools which can be found [here](https://sumuri.com/software/paladin/)
- **CAINE (Computer Aided Investigative Environment):** A GUI project which provides many open source forensic tools for free which can be found [here](https://sumuri.com/software/paladin/)
